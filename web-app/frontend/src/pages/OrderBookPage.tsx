...
function buildMarkdownReport(report: TradesReport): string {
  ...
  lines.push(``, `_Algo-Crypto Order Book export_`, ``);
  return lines.join("\n");
}
...
export function OrderBookPage() {
  ...
  const exportCsv = () => {
    ...
    downloadBlob(
      `algocrypto_orderbook_${stamp}.csv`,
      tradesToCsv(trades),
  ...
  const exportJson = () => {
    ...
    const stamp = `${fromDate || "all"}_${toDate || "all"}`;
    downloadBlob(
      `algocrypto_pnl_report_${stamp}.json`,
  ...
  const exportMarkdown = () => {
    ...
    const stamp = `${fromDate || "all"}_${toDate || "all"}`;
    downloadBlob(
      `algocrypto_pnl_report_${stamp}.md`,
