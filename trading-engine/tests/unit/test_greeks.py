...
from algocrypto.option_data.greeks import compute_greeks, implied_volatility, years_to_expiry
...
def test_trend_continuation_bear():
  ...
  from algocrypto.features.engine import _detect_trend_continuation
