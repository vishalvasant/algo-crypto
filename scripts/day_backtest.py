...
for _name in ("algocrypto", "httpx", "httpcore"):
    logging.getLogger(_name).setLevel(logging.WARNING)

from algocrypto.broker.auth import ensure_session
from algocrypto.broker.flattrade import FlattradeAdapter
from algocrypto.bus.event_bus import EventBus
from algocrypto.config import AppConfig, EnvSettings, get_config
...
from algocrypto.option_data.greeks import DEFAULT_RATE, _bs_price, compute_greeks, years_to_expiry
...
from algocrypto.risk.engine import fit_lots_to_capital, lots_for_confidence
...
async def run_backtest(
    ...
    *,
    ...
    lines = [
        f"# Algo-Crypto Day Backtest Report — {payload['date']}",
        "",
        "## Session overview",
        "",
        f"| Field | Value |",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Algo-Crypto day backtest")
    parser.add_argument(
        "--date",
